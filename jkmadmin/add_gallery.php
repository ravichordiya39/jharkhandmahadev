...

{
   ...
   if(isset($_FILES['banner']) && !empty($_FILES['banner']['name'])){
    ...
    $last_id = $db->insert ('gallery', $data_to_store);
...
<div class="row">
  <div class="col-sm-6">
    <h2 class="page-header">Add Gallery</h2>
  </div>
  <div class="col-sm-6">
    <ul class="breadcrumb">
    ...
    <form class="form" action="" method="post"  id="gallery_form" enctype="multipart/form-data">

       <?php  include_once('./forms/gallery_form.php'); ?>
