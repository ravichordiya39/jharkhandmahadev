...
$db = getDbInstance();
$select = array('id', 'title', 'tagline', 'banner','created_at','updated_at');
...
$customers = $db->arraybuilder()->paginate("banners", $page, $select);
    ...
    <div class="row">
        ...
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_banner.php?operation=create">
        ...
        <tbody>
            <?php foreach ($customers as $row) : ?>
                <tr>
	                ...
	                <td><?php if(!empty($row['banner'])){ ?><img src="uploads/banners/<?php echo htmlspecialchars($row['banner']); ?>" width="100"><?php } ?> </td>
	                <td>
					<a href="edit_banner.php?banner_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="banners.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
